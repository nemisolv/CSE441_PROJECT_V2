...
public class WeatherWeekAdapter extends RecyclerView.Adapter<WeatherWeekAdapter.WeatherNextHolder> {
    private final List<DailyForecast> weatherList;

    public WeatherWeekAdapter(List<DailyForecast> weatherList) {
    ...
    public void updateData(List<DailyForecast> weatherForecasts) {
        weatherList.clear();
        weatherList.addAll(weatherForecasts);
